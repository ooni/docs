...
# version: ooni/backend/docs/OtherComponents.md:02ad28e7
title: Other components
description: Other components, nginx, jupyter notebooks, etc. 
slug: 9
sidebar:
    order: backend/other-components
---
[edit file](https://github.com/ooni/backend/edit/master/docs/OtherComponents.md)
