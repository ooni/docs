...
# version: ooni/data/oonipipeline/Design.md:15e53b2
title: OONI Data Pipeline design
description: Design for OONI Pipeline v5
slug: data/pipeline-design
sidebar:
    order: 3
---
[edit file](https://github.com/ooni/data/edit/main/oonipipeline/Design.md)
