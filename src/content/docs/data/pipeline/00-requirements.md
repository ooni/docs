...
# version: ooni/data/docs/requirements.md:3341923
title: "Requirements"
description: "What the OONI data pipeline must achieve, and how designs are assessed against it"
slug: data/pipeline-design
sidebar:
    order: 0
---
[edit file](https://github.com/ooni/data/edit/main/docs/requirements.md)
...
Companions: [Architecture](/data/pipeline) (how it runs),
...
[Implementation plan](/data/pipeline-implementation-plan) (current state and next
steps).
