...
# version: ooni/data/docs/ontology.md:b11357f
title: "Ontology"
description: "What the pipeline entities mean and what the numbers claim"
slug: data/pipeline-ontology
sidebar:
    order: 2
---
[edit file](https://github.com/ooni/data/edit/main/docs/ontology.md)

What the entities mean and what the numbers claim. Read this before
interpreting any output or adding any field.

Companions: [Requirements](/data/pipeline-design) (what it must achieve),
[Architecture](/data/pipeline) (how it runs),
[User guide](/data/pipeline-user-guide) (consuming it),
[Developer guide](/data/pipeline-developer-guide) (working on it),
[Implementation plan](/data/pipeline-implementation-plan) (what happens next).
Bare ids like `E3` or `A4` cite [Requirements](/data/pipeline-design).
...
([Implementation plan](/data/pipeline-implementation-plan) §3.13).
...
affordable. [Architecture](/data/pipeline) §3.3 records it as new
...
[Architecture](/data/pipeline) §3.1 explains why the insert-time form
...
- **Rot.** Rule ids are a public contract but they still change as rules split.
  ...
  ([Implementation plan](/data/pipeline-implementation-plan) §3.3), and every label
...
[Label corpus](/data/pipeline-label-corpus) producing its first
...
[Label corpus](/data/pipeline-label-corpus) §1.2, and the editor is
