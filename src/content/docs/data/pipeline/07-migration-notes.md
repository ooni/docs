...
# version: ooni/data/docs/migration-notes.md:f45bf40
title: "Migration notes"
description: "Operations to run by hand against a live ClickHouse cluster, in deploy order"
slug: data/pipeline-migration-notes
sidebar:
    order: 7
---
[edit file](https://github.com/ooni/data/edit/main/docs/migration-notes.md)
