...
# version: ooni/probe-cli:5400260
...
| ![a graph depicting the internal dependencies to and from internal/netx](../../../assets/images-probe-engine/git-probe-cli-netx-deps.png) |
|:---------------------------------------------------------------------------------------------------------:|
|                               *Figure 1: dependencies around internal/netx*                               |

| ![histogram of chnges in probe-cli codebase](../../../assets/images-probe-engine/git-probe-cli-change-histogram.png) |
|:------------------------------------------------------------------------------------:|
